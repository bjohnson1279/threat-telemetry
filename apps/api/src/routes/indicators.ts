...
router.post(
  ...
  async (req: Request, res: Response, next) => {
    try {
      ...
      // Parallelize chunk insertions using Promise.all to avoid sequential network roundtrips.
      // Expected impact: Substantially reduces ingestion time for large payloads.
