...
## 2026-09-22 - Focus loss on unmounted elements
**Learning:** When a conditionally rendered interactive element (like a 'Clear search' button) unmounts upon activation, keyboard users experience sudden focus loss, which disrupts navigation.
**Action:** Always programmatically restore focus to a logical next element (e.g., the associated input field) using a React ref before or immediately after the element unmounts.
